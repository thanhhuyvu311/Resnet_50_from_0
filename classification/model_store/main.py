...
if __name__ == '__main__':
    ...
    model_path = 'model_50_epochs.keras'
    history_path = '/home/huy/Documents/de_tai_tot_nghiep/classification/history_store/50_epochs_history_model.csv'
    model =  tf.keras.models.load_model(model_path)
    #doc file csv chua ten nhan
    test_df = pd.read_csv('/home/huy/Documents/de_tai_tot_nghiep/classification/FLIR_ADAS_v2.v1i.multiclass/test/test_data.csv')
    ...
    test_data = test_data_gen.flow_from_dataframe(dataframe=test_df,
                                                    directory='/home/huy/Documents/de_tai_tot_nghiep/classification/FLIR_ADAS_v2.v1i.multiclass/test', #duong dan chua file anh
